...
import { SeedDatabaseCommand } from './seed-database.command.js';
import { PrismaService } from '../../../prisma/prisma.service.js';
import * as bcrypt from 'bcryptjs';

@CommandHandler(SeedDatabaseCommand)
export class SeedDatabaseHandler implements ICommandHandler<SeedDatabaseCommand> {
  constructor(private readonly prisma: PrismaService) {}

  async execute() {
    console.log('Seeding database via API (CQRS)...');
    ...
    const questions = [
      {
        ...
        options: { A: "treatment", B: "treat", C: "treated", D: "treating" } as any,
        correctAnswer: "A",
      ...
      },
      {
        ...
        options: { A: "him", B: "himself", C: "his", D: "he" } as any,
        correctAnswer: "C",
    ...
    await this.prisma.user.create({
      data: {
        ...
        role: "student",
        allowedCourses: ["toan-9-he-2k12", "tieng-anh-9-he-2k12"] as any,
        allowedExams: ["so-ha-noi-2026"] as any,
      },
    });

    console.log('Seeding complete successfully via API (CQRS)!');
